...
public class AgendamentoController {
    ...
    public void btnAlterar() {
        ...
        this.view.getcPaciente().setSelectedItem(consulta.getPaciente().getNome());
        this.view.getcHorario().setSelectedItem(consulta.getHorario());
        this.view.getTfEspecialidade().setSelectedItem(consulta.getMedico().getEspecialidade());
        this.view.getcMedico().setSelectedItem(consulta.getMedico().getNome());
