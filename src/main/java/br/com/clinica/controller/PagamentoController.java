...
public class PagamentoController {
    ...
    public void pacientesPendentesParaPagar() {
        ...
        try {
            ...
            if (agendamento.getPagamento().equals("Aguardando")) {
                this.view.getTfNome().setText(agendamento.getPaciente().getNome());
                this.view.getLblEspecialidade().setText(agendamento.getMedico().getEspecialidade());
            } else if (agendamento.getMedico().getEspecialidade().equals("Cardiologista")) {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null,"Nenhum agendamento encontrado" + e);
