...
public class PacienteModeloTabela extends AbstractTableModel {
    ...
    private String[] nomeColuna = {"ID", "Nome", "Data de Nascimento", "CPF", "Sexo"};
    ...
    public void setValueAt(Object valor, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 1:
                ...
                break;
            case 2:
                pacientes.get(rowIndex).setDataNascimento((Date) valor);
                break;
    ...
    public void removerLinhaTabela(int linha){
        this.pacientes.remove(linha);
